...
layout(location = 0) in vec4 Square_vertices; //This takes vertices to draw a triangle or a square from
...
uniform mat4 MVP_matrix;							//This is responsible for change in the transformations

out vec2 cords_tex;								//This is used for the positions of the texture where it should it be placed

void main()
{
	gl_Position = MVP_matrix*vec4(Square_vertices.xy,1.0,1.0);
	//vertcolor = Color_Send;
	cords_tex = Square_vertices.zw;//TexCords;
}